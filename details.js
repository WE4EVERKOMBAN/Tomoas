module.exports = {
    ...
    bot_token:'5776057284:AAF_dXoL1dZUnVINe1CDwe9DdYurC29xqnI',//bot token
    
    bot_name:'ImpulseXAirdrops_Bot',//bot username without @
    ...
    min_wd:10000,//min withdrawal amount
    
    daily_bonus:100000,// daily bonus amount
    
    currency:'MetaJoker', //bot cuurency
